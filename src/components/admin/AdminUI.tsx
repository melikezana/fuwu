          ...
          >
            {adminNavItems.map((item) => {
              ...
              return (
                <Link
                  className={cn(
                    "inline-flex min-h-11 shrink-0 max-w-full items-center gap-2 rounded-md border px-3 py-2 text-sm font-bold leading-5 shadow-[var(--shadow-subtle)] transition-colors",
                    isActive
