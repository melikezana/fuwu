      ...
      {isOpen ? (
        <div className="mb-3 w-[min(calc(100vw-2rem),320px)] cursor-default select-none rounded-lg border border-[var(--border)] bg-white p-4 shadow-[0_22px_70px_rgba(13,20,36,0.18)]">
          ...
          <div className="mt-4 grid gap-2">
            <a
              className="inline-flex min-h-10 w-full cursor-pointer items-center justify-center gap-2 rounded-md bg-[var(--brand-orange)] px-4 text-sm font-bold text-white shadow-[0_14px_30px_rgba(255,138,0,0.22)] transition-colors hover:bg-[var(--brand-orange-dark)]"
            ...
            <div className="grid grid-cols-2 gap-2">
              <a
                ...
                className="inline-flex min-h-10 cursor-pointer items-center justify-center gap-2 rounded-md bg-[var(--surface-soft)] px-3 text-sm font-bold text-[var(--brand-navy)] transition-colors hover:bg-[var(--brand-orange-soft)]"
              ...
              <a
                aria-label="Fuwu destek e-postası gönder"
                className="inline-flex min-h-10 cursor-pointer items-center justify-center gap-2 rounded-md bg-[var(--surface-soft)] px-3 text-sm font-bold text-[var(--brand-navy)] transition-colors hover:bg-[var(--brand-orange-soft)]"
