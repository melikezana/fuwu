    ...
    <header className="sticky top-0 z-30 border-b border-[rgba(13,20,36,0.08)] bg-white/[0.97] shadow-[0_10px_30px_rgba(13,20,36,0.045)] backdrop-blur-xl">
      <Container className="py-3 xl:py-0">
        ...
        >
          ...
          {isMenuOpen ? (
            <div
              className="absolute left-0 right-0 top-[calc(100%+0.75rem)] z-50 max-h-[min(70vh,24rem)] overflow-y-auto rounded-lg border border-[rgba(13,20,36,0.08)] bg-white py-2 shadow-[0_22px_60px_rgba(13,20,36,0.16)] xl:hidden"
