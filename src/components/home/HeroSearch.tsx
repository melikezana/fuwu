  ...
  return (
    ...
    >
      <div className="grid min-w-0 gap-0 sm:grid-cols-[minmax(0,1.18fr)_minmax(11.5rem,0.72fr)_auto]">
        <label className="grid min-h-[64px] min-w-0 grid-cols-[3rem_minmax(0,1fr)] items-center border-b border-[var(--border)] px-2 sm:border-b-0 sm:border-r">
        ...
        <div className="p-2">
          <Button className="h-[50px] min-h-[50px] w-full rounded-md px-7 sm:w-auto" type="submit">
            Usta Bul
          </Button>
        </div>
      </div>
