...
export const metadata: Metadata = {
  ...
  description: "Aylık kazanç özeti ve tamamlanan iş istatistikleri.",
};

// Demo veriler (Supabase bağlı değilken gösterilir)
const MOCK_STATS = {
  totalRequests: 47,
  ...
  reviewCount: 23,
  responseRate: 89,
  thisMonthCompleted: 9,
  thisMonthEarnings: 8400,
};

const monthlyData = [
  { ay: "Oca", kazanc: 4200, is: 5 },
  { ay: "Şub", kazanc: 3800, is: 4 },
  { ay: "Mar", kazanc: 5100, is: 6 },
  { ay: "Nis", kazanc: 4600, is: 5 },
  { ay: "May", kazanc: 2650, is: 3 },
  { ay: "Haz", kazanc: 8400, is: 9 },
];
